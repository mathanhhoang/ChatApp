...
import my.thanhhoang.chatapp.Adapter.MessageAdapter;
import my.thanhhoang.chatapp.Fragment.APIService;
import my.thanhhoang.chatapp.Model.Chat;
import my.thanhhoang.chatapp.Model.User;
import my.thanhhoang.chatapp.Notifications.Client;
import my.thanhhoang.chatapp.Notifications.Data;
        ...
        btn_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!msg.equals("")) {
                    ...
                    Toast.makeText(MessageActivity.this, "Khong the gui tin nhan khi khong nhap", Toast.LENGTH_SHORT).show();
                }
                text_send.setText("");
            }
        });
